                        ...
                        {[...Array(5)].map((_, i) => (
                            <SwiperSlide key={i}>
                                <div className="sa-hero-text-item">
                                    <h3 className="sa-hero-text-title"><Link href="/contact-us">Amazing Services</Link></h3>
                                </div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
...
export default ServiceThreeHero;